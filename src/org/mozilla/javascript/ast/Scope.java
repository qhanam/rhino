...
public class Scope extends Jump {
    ...
    /**
     * Used by the parser; not intended for typical use. Changes the parent-scope
     * links for this scope's child scopes to the specified new scope. Copies
     * symbols from this scope into new scope.
     *
     * @param newScope
    ...
    /**
     * Creates a new scope node, moving symbol table information from "scope" to the
     * new node, and making "scope" a nested scope contained by the new node. Useful
     * for injecting a new scope in a scope chain.
     */
     ...
     * @return this {@link Scope}, one of its parent scopes, or {@code null} if the
     *         name is not defined any this scope chain
     */
     ...
     *             if any non-{@code AstNode} objects are in the child list, e.g. if
     *             this method is called after the code generator begins the tree
     *             transformation.
     */
