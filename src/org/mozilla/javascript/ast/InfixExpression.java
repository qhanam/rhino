...
public class InfixExpression extends AstNode {
    ...
    /**
     * Constructs a new {@code InfixExpression}. Updates bounds to include left and
     * right nodes.
     */
    ...
    /**
     * Sets operator token &ndash; like {@link #setType}, but throws an exception if
     ...
     * 
     * @return the right-hand side. It's usually an {@link AstNode} node, but can
     *         also be a {@link FunctionNode} representing Function expressions.
     */
