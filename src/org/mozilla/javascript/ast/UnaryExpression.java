...
public class UnaryExpression extends AstNode {
    ...
    /**
     * Constructs a new UnaryExpression with the specified operator and operand. It
     * sets the parent of the operand, and sets its own bounds to encompass the
	...
	if (this.getOperand() != null)
	    operand = this.getOperand().clone(clone);
	clone.setOperand(operand);
	if (operand != null)
	    operand.setParent(clone);
    ...
    /**
     * Sets operator &ndash; same as {@link #setType}, but throws an exception if
